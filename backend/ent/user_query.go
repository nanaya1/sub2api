...
func (_q *UserQuery) QueryOauthAuthorizationTransactions() *OAuthAuthorizationTransactionQuery {
...
func (_q *UserQuery) QueryOauthAccessTokens() *OAuthAccessTokenQuery {
...
func (_q *UserQuery) QueryOauthRefreshTokens() *OAuthRefreshTokenQuery {
...
func (_q *UserQuery) QueryOauthManagedAPIKeys() *OAuthManagedAPIKeyQuery {
...
func (_q *UserQuery) WithOauthAuthorizationTransactions(opts ...func(*OAuthAuthorizationTransactionQuery)) *UserQuery {
	query := (&OAuthAuthorizationTransactionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithOauthAccessTokens(opts ...func(*OAuthAccessTokenQuery)) *UserQuery {
	query := (&OAuthAccessTokenClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithOauthRefreshTokens(opts ...func(*OAuthRefreshTokenQuery)) *UserQuery {
	query := (&OAuthRefreshTokenClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithOauthManagedAPIKeys(opts ...func(*OAuthManagedAPIKeyQuery)) *UserQuery {
	query := (&OAuthManagedAPIKeyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withOauthAuthorizationTransactions; query != nil {
		if err := _q.loadOauthAuthorizationTransactions(ctx, query, nodes,
			func(n *User) { n.Edges.OauthAuthorizationTransactions = []*OAuthAuthorizationTransaction{} },
			func(n *User, e *OAuthAuthorizationTransaction) {
	...
	if query := _q.withOauthAccessTokens; query != nil {
		if err := _q.loadOauthAccessTokens(ctx, query, nodes,
			func(n *User) { n.Edges.OauthAccessTokens = []*OAuthAccessToken{} },
			func(n *User, e *OAuthAccessToken) { n.Edges.OauthAccessTokens = append(n.Edges.OauthAccessTokens, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOauthRefreshTokens; query != nil {
		if err := _q.loadOauthRefreshTokens(ctx, query, nodes,
			func(n *User) { n.Edges.OauthRefreshTokens = []*OAuthRefreshToken{} },
			func(n *User, e *OAuthRefreshToken) {
	...
	if query := _q.withOauthManagedAPIKeys; query != nil {
		if err := _q.loadOauthManagedAPIKeys(ctx, query, nodes,
			func(n *User) { n.Edges.OauthManagedAPIKeys = []*OAuthManagedAPIKey{} },
			func(n *User, e *OAuthManagedAPIKey) {
...
func (_q *UserQuery) loadOauthAuthorizationTransactions(ctx context.Context, query *OAuthAuthorizationTransactionQuery, nodes []*User, init func(*User), assign func(*User, *OAuthAuthorizationTransaction)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(oauthauthorizationtransaction.FieldUserID)
	}
	query.Where(predicate.OAuthAuthorizationTransaction(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.OauthAuthorizationTransactionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserQuery) loadOauthAccessTokens(ctx context.Context, query *OAuthAccessTokenQuery, nodes []*User, init func(*User), assign func(*User, *OAuthAccessToken)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(oauthaccesstoken.FieldUserID)
	}
	query.Where(predicate.OAuthAccessToken(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.OauthAccessTokensColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserQuery) loadOauthRefreshTokens(ctx context.Context, query *OAuthRefreshTokenQuery, nodes []*User, init func(*User), assign func(*User, *OAuthRefreshToken)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(oauthrefreshtoken.FieldUserID)
	}
	query.Where(predicate.OAuthRefreshToken(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.OauthRefreshTokensColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserQuery) loadOauthManagedAPIKeys(ctx context.Context, query *OAuthManagedAPIKeyQuery, nodes []*User, init func(*User), assign func(*User, *OAuthManagedAPIKey)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(oauthmanagedapikey.FieldUserID)
	}
	query.Where(predicate.OAuthManagedAPIKey(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.OauthManagedAPIKeysColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
