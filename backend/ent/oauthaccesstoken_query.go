...
func (_q *OAuthAccessTokenQuery) QueryUser() *UserQuery {
...
func (_q *OAuthAccessTokenQuery) QueryClient() *OAuthClientQuery {
...
func (_q *OAuthAccessTokenQuery) WithUser(opts ...func(*UserQuery)) *OAuthAccessTokenQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *OAuthAccessTokenQuery) WithClient(opts ...func(*OAuthClientQuery)) *OAuthAccessTokenQuery {
	query := (&OAuthClientClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OAuthAccessTokenQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*OAuthAccessToken, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *OAuthAccessToken, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withClient; query != nil {
		if err := _q.loadClient(ctx, query, nodes, nil,
			func(n *OAuthAccessToken, e *OAuthClient) { n.Edges.Client = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *OAuthAccessTokenQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*OAuthAccessToken, init func(*OAuthAccessToken), assign func(*OAuthAccessToken, *User)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*OAuthAccessToken)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *OAuthAccessTokenQuery) loadClient(ctx context.Context, query *OAuthClientQuery, nodes []*OAuthAccessToken, init func(*OAuthAccessToken), assign func(*OAuthAccessToken, *OAuthClient)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*OAuthAccessToken)
	for i := range nodes {
		fk := nodes[i].ClientID
...
func (_q *OAuthAccessTokenQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(oauthaccesstoken.FieldUserID)
		}
		if _q.withClient != nil {
			_spec.Node.AddColumnOnce(oauthaccesstoken.FieldClientID)
		}
	}
