...
func (_u *APIKeyUpdate) AddOauthManagedAPIKeyIDs(ids ...int64) *APIKeyUpdate {
...
func (_u *APIKeyUpdate) AddOauthManagedAPIKeys(v ...*OAuthManagedAPIKey) *APIKeyUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *APIKeyUpdate) ClearOauthManagedAPIKeys() *APIKeyUpdate {
...
func (_u *APIKeyUpdate) RemoveOauthManagedAPIKeyIDs(ids ...int64) *APIKeyUpdate {
...
func (_u *APIKeyUpdate) RemoveOauthManagedAPIKeys(v ...*OAuthManagedAPIKey) *APIKeyUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddOauthManagedAPIKeyIDs adds the "oauth_managed_api_keys" edge to the OAuthManagedAPIKey entity by IDs.
func (_u *APIKeyUpdateOne) AddOauthManagedAPIKeyIDs(ids ...int64) *APIKeyUpdateOne {
	_u.mutation.AddOauthManagedAPIKeyIDs(ids...)
	return _u
}

// AddOauthManagedAPIKeys adds the "oauth_managed_api_keys" edges to the OAuthManagedAPIKey entity.
func (_u *APIKeyUpdateOne) AddOauthManagedAPIKeys(v ...*OAuthManagedAPIKey) *APIKeyUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearOauthManagedAPIKeys clears all "oauth_managed_api_keys" edges to the OAuthManagedAPIKey entity.
func (_u *APIKeyUpdateOne) ClearOauthManagedAPIKeys() *APIKeyUpdateOne {
	_u.mutation.ClearOauthManagedAPIKeys()
	return _u
}

// RemoveOauthManagedAPIKeyIDs removes the "oauth_managed_api_keys" edge to OAuthManagedAPIKey entities by IDs.
func (_u *APIKeyUpdateOne) RemoveOauthManagedAPIKeyIDs(ids ...int64) *APIKeyUpdateOne {
	_u.mutation.RemoveOauthManagedAPIKeyIDs(ids...)
	return _u
}

// RemoveOauthManagedAPIKeys removes "oauth_managed_api_keys" edges to OAuthManagedAPIKey entities.
func (_u *APIKeyUpdateOne) RemoveOauthManagedAPIKeys(v ...*OAuthManagedAPIKey) *APIKeyUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
